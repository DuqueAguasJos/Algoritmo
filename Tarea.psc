...
//entrada = descuento(leer) (0, 5 , 10), compra(leer), descuentoapli, subtotal (calcular), total(calcular) como real
//proceso = elegir el descuento que desea aplicar
...
//entrada: edad(leer) como entero
//Proceso si edad>=0 Entonces
//         sino 
//           si edad>=13
//           SiNo
//             si edad>=18
...
//Proceso si puntuacion>=0 y puntuacion<=4
...
//entrada numer(leer)
//Proceso si numer mod 3= 0 o numer mod 9= 0 o numer mod 12=0
//         escribir "El numero es multiplo de 3, 9 y 12"
//        SiNo
...
//Proceso:  Si servicio = malo
//           propina<- valor * (propina0/100)
//           total<- valor + propina
//          sino 
//            si servicio = bueno
...
//entrada:compra(leer)
//Proceso si compra >=0 y compra <=10
...
//entrada numer(leer), total(calcular) 
//Proceso si numer>0
//          total<- numer *2 
//        SiNo
//           si numer<0
...
//entrada billete10(calcular), billete5(calcular), vuelto(leer)
//Proceso billete10<- trunc(vuelto/10)
...
//entrada anio (leer)
//proceso 
//Si anio mod 4 = 0 y anio mod 100 <> 0 o anio mod 400 Entonces
...
//entrada: horas(leer) 0, minutos(calcular) 0 , segundos(calcular)0 
...
//proceso si fiebre = SI y respirar = SI y pecho = SI
//           escribir 
//        SiNo
//           Escribir 
...
//entrada: Presionsistolica como entero
//proceso: si presionsitolica <= 90
//          escribir
//         SiNo
...
//entrada: vocal (leer) Como Caracter
//proceso: si vocal = "a" o vocal ="e" o vocal = "i" o vocal = "o" o vocal = "u"
...
// proceso: si letra <> "a" Y letra <> "e" Y letra <> "i" Y letra <> "o" Y letra <> "u" Entonces
//            Escribir 
//          SiNo
...
//entrada: nombre1(leer)"", nombre2(leer)"" como cadena
...
//entrada: palabra (leer)"" como cadena
//longitu (calcular) 0 como entero
